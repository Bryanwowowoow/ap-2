...
function Call_hard_map () {
    game.showLongText("you must find a way out", DialogLayout.Bottom)
    tiles.placeOnRandomTile(powerup, sprites.builtin.oceanDepths4)
}
function Break_wallwith_powerup () {
    // Find the wall sprite in the game
    wall = sprites.allOfKind(SpriteKind.Player)[0]
    if (wall) {
        // If a wall sprite is found, remove it from the game
        wall.destroy()
        // Optionally play a sound effect or add visual effects
        music.powerUp.play()
        effects.confetti.startScreenEffect()
        // Inform the player that the wall has been broken
        game.showLongText("power up used", DialogLayout.Bottom)
    }
}
...
function set_random_spawn () {
	
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    Break_wallwith_powerup()
})
function walking_mechanics () {
	
}
scene.onHitWall(SpriteKind.p1, function (sprite, location) {
...
miniMenu.createMenuItem("Hard map", img`
    ...........ccccc66666...........
    ........ccc4444444444666........
    ...
    ................................
    `),
miniMenu.createMenuItem("3d map", img`
    . . . . . . . . . . b 5 b . . . 
    . . . . . . . . . b 5 b . . . . 
    . . . . . . b b b b b b . . . . 
    . . . . . b b 5 5 5 5 5 b . . . 
    ...
    . . . c c c c c c c c b b . . . 
    `),
miniMenu.createMenuItem("losers map", img`
    . . . . . f f 4 4 f f . . . . . 
    . . . . f 5 4 5 5 4 5 f . . . . 
    . . . f e 4 5 5 5 5 4 e f . . . 
...
scene.setBackgroundImage(img`
    ...
    `)
tiles.placeOnTile(powerup, tiles.getTileLocation(0, 0))
